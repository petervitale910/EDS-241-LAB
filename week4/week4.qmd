...
*Response:* Reef exposure and dist_fish_settl seem the most different.
...
*Response:* Exposure could effect the biomass and artificially increase the amount of fish apparent in the MPA sites as there are more areas for them to seek refuge. 
...
*Response:* 37 control units and 108 treated units were matched
...
*Response:* The treatment is about 107.78 kg/ha more biomass than controls sites, and we expect to see these results with randomly generated data in only 8% of cases (statistical significance)

**Q8.** What is the biggest remaining threat to causal interpretation of regression coefficients after matching?

*Response:* Confounding variables that *weren't* sampled remain as a threat to the causal interpretation of regression coefficients after matching. 
...
*Response:* The estimate gets slightly larger, which indicates that the confounds included do in fact have an effect on our model. 
...
*Response:* Storm patterns can vary by year, and in higher storm years we could expect more of a disruption in both mpa and control 
...
*Response:* Plots can be placed near different vegetation which impact soil quality and nutrients. 
